const playlist = [
    ...
    { type: 'image', url: 'img/img50.jpeg', caption: 'חוגגת יום הולדת צעיר עם האחים' },
    ...
    { type: 'image', url: 'img/img5.jpeg', caption: 'רגע הבדקן המרגש... מתחת להינומה' },
    ...
    { type: 'image', url: 'img/img18.jpeg', caption: 'יומולדת משפחתי שמח, עם הפתעות וגם עם הכלב' },
    ...
    { type: 'image', url: 'img/img34.jpeg', caption: 'חבורה של אנשים שמחים שמצביעים עליך באהבה!' },
