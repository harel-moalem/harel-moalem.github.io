const playlist = [
    ...
    { type: 'image', url: 'img/img47.jpeg', caption: 'עם איש שלג מתוק וכבר אז חיוך כובש' },
    { type: 'image', url: 'img/img48.jpeg', caption: 'מתרוצצת בחוץ, סקרנית ומלאת שמחת חיים' },
    { type: 'image', url: 'img/img49.jpeg', caption: 'תקופת הנעורים והרפתקאות יפות' },
    { type: 'image', url: 'img/img50.jpeg', caption: 'רגעים עם המשפחה' },
    ...
    { type: 'image', url: 'img/img5.jpeg', caption: 'רגע מרגש... מתחת להינומה' },
    { type: 'image', url: 'img/img6.jpeg', caption: 'הכלה הכי יפה שיש' },
    { type: 'image', url: 'img/img7.jpeg', caption: 'בונים יחד עתיד וקן משפחתי' },
    { type: 'image', url: 'img/img12.jpeg', caption: 'תמיד מוצאים סיבה לחייך ולהשתטות יחד' },
    { type: 'image', url: 'img/img15.jpeg', caption: 'זוגיות צעירה, יפה ומלאת אהבה' },
    { type: 'image', url: 'img/img54.jpeg', caption: 'זוגיות שמחזיקה שנים של אושר' },
    // פרק ג
    { type: 'image', url: 'img/img10.jpeg', caption: 'תקופה של חגיגות, שמחות ואירועים' },
    { type: 'image', url: 'img/img13.jpeg', caption: 'חוגגים עוד שנה של אושר, אהבה ועוגה טעימה' },
    ...
    { type: 'image', url: 'img/img16.jpeg', caption: 'סלפי משפחתי מושלם – כולנו ביחד' },
    { type: 'image', url: 'img/img17.jpeg', caption: 'רגע מרגש של אמא ובת ביום חתונתה' },
    { type: 'image', url: 'img/img18.jpeg', caption: 'יומולדת משפחתי שמח, עם הפתעות וגם עם סאן' },
    { type: 'image', url: 'img/img3.jpeg', caption: 'חוגגים ביחד ברגעים שמחים ומלאי אנרגיה' },
    { type: 'image', url: 'img/img26.jpeg', caption: 'מפגש משפחתי חם עם חברים ואהובים' },
    { type: 'image', url: 'img/img34.jpeg', caption: 'רגעים של כיף ואושר עם המשפחה המורחבת!' },
    { type: 'image', url: 'img/img35.jpeg', caption: 'חגיגת חינה מסורתית, צבעונית ושמחה במיוחד' },
    { type: 'image', url: 'img/img53.jpeg', caption: 'חיוכים עם הבן האוהב' },
    ...
    { type: 'image', url: 'img/img20.jpeg', caption: 'להחזיק את הקטנטנים קרוב ללב, אין אושר כזה' },
    { type: 'image', url: 'img/img21.jpeg', caption: 'שלושה דורות של אהבה ויופי משפחתי' },
    { type: 'image', url: 'img/img22.jpeg', caption: 'סבתא יקרה ואהובה – תמיד מוקפת בבלונים של שמחה' },
    { type: 'image', url: 'img/img23.jpeg', caption: 'רגעים שלא נשכח' },
    { type: 'image', url: 'img/img24.jpeg', caption: 'חבוקה עם הנכד המתוק – רגעי נחת אמיתיים' },
    { type: 'image', url: 'img/img25.jpeg', caption: 'חיוכים משפחתיים שמחממים את הלב' },
    ...
    { type: 'image', url: 'img/img40.jpeg', caption: 'חוגגים באירוע משפחתי מלא בסטייל ואור' },
    { type: 'image', url: 'img/img41.jpeg', caption: 'סלפי משפחתי קבוצתי ומאושר עם הנכד' },
    { type: 'image', url: 'img/img42.jpeg', caption: 'יחד עם הנכד האהוב וחגיגה של בלונים' },
    { type: 'image', url: 'img/img43.jpeg', caption: 'יום הולדת שמח ומלא בפרחים ובלונים צבעוניים!' },
    ...
    { type: 'image', url: 'img/img28.jpeg', caption: 'כל המשפחה ביחד, חוגגים סביב השולחן' },
    { type: 'image', url: 'img/img29.jpeg', caption: 'הגאווה הגדולה של החיים שלך - המשפחה שלך' },
    { type: 'image', url: 'img/img30.jpeg', caption: 'לבושים בלבן וחגיגיים – רגע משפחתי מאוחד' },
    { type: 'image', url: 'img/img32.jpeg', caption: 'הילדים הנהדרים שלך – הגאווה הכי גדולה' },
    { type: 'image', url: 'img/img33.jpeg', caption: 'בהתרגשות של אירועים משפחתיים משמחים' },
